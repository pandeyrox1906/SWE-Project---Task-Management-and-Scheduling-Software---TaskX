          ...
          <div className="col-md-9">
            <div className="row justifiy-content-end">
              ...
              <div className="col-md-4 my-auto text-left">
                ...
                <p>Through Our Project, we would like to develop a Product that models a task management and scheduling software which includes features like Management and Scheduling of tasks from a Project Managers Perspective.  </p>
              </div>
            </div>
          </div>
